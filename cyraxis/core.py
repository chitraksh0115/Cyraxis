"""
cyraxis/core.py — the LLM interface module
Module 1 of CYRAXIS : Grounded Research for Open Knowledge

All other CYRAXIS modules call ask() to interact with the LLM.
This module handles: API key loading, model selection,
error handling, and the core ask() interface.
...
def ask(
    ...
    Args:
        ...
        system:     The system prompt that defines CYRAXIS's behaviour.
...
if __name__ == "__main__":
    ...
    # python grok/core.py
    print("Testing CYRAXIS core.py...")
    print("=" * 50)

    response = ask("What is mechanistic interpretability in one sentence?")
    print(f"CYRAXIS: {response}")

    print("\n" + "=" * 50)
    print("✓ core.py working — Groq API call succeeded.")